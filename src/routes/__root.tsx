...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "¿Kedamos?" },
      { name: "description", content: "¿Kedamos? conecta a gente para hacer planes juntos, no para tener citas." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "¿Kedamos?" },
      { property: "og:description", content: "¿Kedamos? conecta a gente para hacer planes juntos, no para tener citas." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "¿Kedamos?" },
      { name: "twitter:description", content: "¿Kedamos? conecta a gente para hacer planes juntos, no para tener citas." },
